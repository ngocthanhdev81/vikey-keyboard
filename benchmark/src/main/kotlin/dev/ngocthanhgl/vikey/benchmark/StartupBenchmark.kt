...
package dev.ngocthanhgl.vikey.benchmark
...
abstract class AbstractStartupBenchmark(private val startupMode: StartupMode) {
    ...
    private fun startup(compilationMode: CompilationMode) = benchmarkRule.measureRepeated(
        packageName = "dev.ngocthanhgl.vikey",
        ...
        setupBlock = {
            pressHome()
            device.executeShellCommand("ime enable dev.ngocthanhgl.vikey/.FlorisImeService")
            device.executeShellCommand("ime set dev.ngocthanhgl.vikey/.FlorisImeService")
        }
    ) {
